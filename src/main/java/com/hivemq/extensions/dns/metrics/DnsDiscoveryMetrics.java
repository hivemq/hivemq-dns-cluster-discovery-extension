...
public class DnsDiscoveryMetrics {
    ...
    private final static @NotNull String DNS_DISCOVERY_EXTENSION = "dns-cluster-discovery-extension";
    private final static @NotNull String HIVEMQ_PREFIX = "com.hivemq";
