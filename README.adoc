...
If a properties file is provided (`dnsdiscovery.properties`), the extension will use the key-value pairs from this file and reload the values on file changes.
