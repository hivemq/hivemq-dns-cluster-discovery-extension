...
|HIVEMQ_DNS_DISCOVERY_INTERVAL_MAX      |60             |maxDiscoveryInterval    |Maximum discovery interval in seconds
|HIVEMQ_DNS_DISCOVERY_INTERVAL_INITIAL  |60             |initialDiscoveryInterval|Initial discovery interval in seconds when using exponential back-off. This is the lower clamping value for the back-off.
|=======================================================================
