...
|HIVEMQ_DNS_DISCOVERY_INTERVAL_INITIAL  |1             |initialDiscoveryInterval|Initial discovery interval in seconds when using exponential back-off. This is the lower clamping value for the back-off.
|=======================================================================
